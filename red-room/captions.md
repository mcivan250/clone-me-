# Post copy — edition one

Four weeks, one night. Post the reveals at the same hour on consecutive days and have
each act repost hers to her own story within the hour — that's what makes the account
feel like it's building to something rather than just posting flyers.

---

## Week 1 — teaser reel, no names
...
> Somebody has to fill the room before it turns red.
...
## Week 3 — Missterious2 (build)

> Two of them. One booth.
...
Story, posted during Silhouette Hour:

> Silhouette Hour. Right now.
> Get in the frame.

Story, posted at the UV switch:

> Lights out. Tattoos on.
